...
private:
  ...
  SparkMaxRelativeEncoder *rtpiSparkMaxEncoder;
  SparkMaxPIDController *rtpiSparkMaxPIDController;
...
public:
  ...
  SparkMaxRelativeEncoder *GetSparkMaxEncoder();
  SparkMaxPIDController *GetSparkMaxPIDController();
